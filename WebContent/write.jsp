...
<link rel="stylesheet" href="css/bootstrap1.css"><%--css파일 가져올수있도록 설정함 --%>
	<link rel="stylesheet" href="css/custom1.css"><%--css파일 가져올수있도록 설정함 --%>
		...
		<div class="row">
			<form method="post" action="writeAction.jsp">
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
					...
					<tbody>
						<tr>
							<td><input type="text" class="table table-striped" placeholder="글 제목" name="bbsTitle" maxlength="50"></td>
						</tr>
						<tr>
							<td><textarea class="table table-striped" placeholder="글 내용" name="bbsContent" maxlength="2048" style="height: 350px;"></textarea></td>
						</tr>
					</tbody>
				</table>
